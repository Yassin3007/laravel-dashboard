    ...
    <div class="app-content content container-fluid">
        <div class="content-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-tooltip">Edit Role #{{ $role->id }}</h4>
                                ...
                                <div class="card-body collapse in">
                                    <div class="card-block">
                                        <div class="card-text">
                                            <p>Update the information for this Role.</p>
                                        </div>

                                        <form class="form" method="POST" action="{{ route('roles.update', $role->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-body">
            ...
            <input type="text" id="guard_name" class="form-control @error('guard_name') is-invalid @enderror"
                   name="guard_name" value="{{ isset($role) ? $role->guard_name : old('guard_name') }}"
